...
tinyIpcLib/*: Contains the tinyIpcLib provided by uderos

SimulaQron/*: Contains the SimulaQron library

The other files in examples are used for observatory testing of BB84 and DIQKD protocols
